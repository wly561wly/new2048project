...
public class MainScene {
    ...
    public MainScene() {
        ...
        label.setFont(font);
        btn_mode1.setLayoutX(200);
        btn_mode1.setLayoutY(200);
        btn_mode2.setLayoutX(300);
        btn_mode2.setLayoutY(300);
        btn_mode3.setLayoutX(0);
        btn_mode3.setLayoutY(0);
        btn_back.setLayoutX(400);
        btn_back.setLayoutY(400);
        ...
        // 将Label添加到VBox中
        root.getChildren().addAll(label, btn_mode1, btn_mode2, btn_mode3,btn_back,btn_back2);
