...
/*        btn_mode1.setLayoutX(400);btn_mode1.setPrefSize(80, 45);
        btn_mode1.setLayoutY(250);btn_mode1.setStyle("-fx-background-color: #00eaff");
        btn_mode2.setLayoutX(400);btn_mode2.setPrefSize(80, 45);
        btn_mode2.setLayoutY(300);btn_mode2.setStyle("-fx-background-color: #00eaff");
        btn_mode3.setLayoutX(400);btn_mode3.setPrefSize(80, 45);
        btn_mode3.setLayoutY(350);btn_mode3.setStyle("-fx-background-color: #00eaff");
        btn_mode4.setLayoutX(400);btn_mode4.setPrefSize(80, 45);
        btn_mode4.setLayoutY(400);btn_mode4.setStyle("-fx-background-color: #00eaff");
        exitButton.setLayoutX(400);exitButton.setPrefSize(80, 45);
        exitButton.setLayoutY(450);exitButton.setStyle("-fx-background-color: #00eaff");*/
        btn_mode1.setLayoutX(400);btn_mode1.setPrefSize(80, 45);
