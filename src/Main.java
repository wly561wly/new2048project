...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        /*try {
            ...
            Method method=StartScene.class.getMethod("getLengthOfString",paramString);
            String str=null;
            Object len = method.invoke(startScene, str);
...
//以下为主界面
        ...
        mainScene.getAIbtn().setOnAction(event->{
            aIscene=new AIscene(4,4,"AI",pattern,"scores",0);
    ...
    public void doExitHintStage(Stage stage)
    {
        ...
        Button saveBtn = new Button("保存并退出");
        Button exitBtn = new Button("直接退出");
        ...
        saveBtn.setOnAction(event ->{
            ...
            else System.out.println("游客不能保存!");
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(path))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 4) {
                    ...
                    System.err.println("不合法的文件: " + line);
                }
            }
        } catch (IOException e) {
    ...
    public void setPattern(int x){
        ...
        if(aIscene!=null)aIscene.setPattern(x);
    }
    ...
    public void dotheSetting(){
        ...
        setting.getChoiceBox().valueProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
                System.out.println("棋盘大小已修改为: " + newValue);
